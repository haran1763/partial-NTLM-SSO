...
<nav>
<form action="/sample/operations/display.jsp">
...
<form action="/sample/operations/create.jsp">
...
<form action="/sample/operations/updateho.jsp">
<input type="submit" id="button" value="Update hospitals" />
</form>

<form action="/sample/operations/update.jsp">
<input type="submit" id="button" value="Update doctors" />
</form>

<form action="/sample/operations/deleteho.jsp">
<input type="submit" id="button" value="Delete hospitals" />
</form>

<form action="/sample/operations/delete.jsp">
